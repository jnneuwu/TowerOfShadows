...
public class ExplosiveCrate : MonoBehaviour
{
    ...
    public void Explode()
    {
        ...
        // Particles + flash
        ParticleFx.Burst(transform.position, new Color(1f, 0.55f, 0.1f), 35, 8f, 0.7f, 0.3f);
        ParticleFx.Burst(transform.position, new Color(0.4f, 0.4f, 0.4f), 18, 5f, 1f, 0.35f);
        ParticleFx.Flash(transform.position, new Color(1f, 0.7f, 0.2f), 4f, 0.25f);
