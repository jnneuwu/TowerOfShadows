...
public class GameManager : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // Lab 5: M toggles music, N toggles sound effects.
        if (AudioManager.Instance != null)
        {
            if (Input.GetKeyDown(KeyCode.M)) AudioManager.Instance.ToggleMusic();
            if (Input.GetKeyDown(KeyCode.N)) AudioManager.Instance.ToggleSFX();
        }
    }
    ...
    {
        // Respawn on the current floor instead of resetting to Floor 1.
        isGameOver = false;
        Time.timeScale = 1f;
        SceneManager.LoadScene("Floor" + currentFloor);
    }
